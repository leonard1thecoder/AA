...
public class UsersRegisterRequest {
    ...
    public UsersRegisterRequest(Privileges fkPrivilegeId, String usersRegistrationDate, String usersPassword, String usersEmailAddress, String usersFullName, Short usersAge, Short usersStatus, Integer noPromotionToken, String usersIdentityNo, String usersModifiedDate) {
    ...
    public Privileges fkPrivilegeId() {
        return fkPrivilegeId;
    }

    public UsersRegisterRequest setFkPrivilegeId(Privileges fkPrivilegeId) {
        this.fkPrivilegeId = fkPrivilegeId;
        return this;
    }

    public Privileges getFkPrivilegeId() {
        return fkPrivilegeId;
    }
