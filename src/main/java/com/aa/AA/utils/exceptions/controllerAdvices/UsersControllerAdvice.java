...
public class UsersControllerAdvice {
    ...
    public static String setMessage(String message) {
        UsersControllerAdvice.message = message;
        return message;
    }
    ...
    public static void setResolveIssueDetails(String resolveIssueDetails) {
        UsersControllerAdvice.resolveIssueDetails = resolveIssueDetails;
    }

    @ExceptionHandler(UserNotFoundException.class)
    public ResponseEntity<ErrorResponse> manageUserNotFoundException(){
        return new ResponseEntity<>(new ErrorResponse(LocalDateTime.now(),getResolveIssueDetails(), getMessage()),HttpStatus.NOT_FOUND);
    }
